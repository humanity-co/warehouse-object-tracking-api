# Warehouse Object Tracking API

A REST API for asset tracking telemetry. It ingests IoT coordinate updates and records movement history in local database instances.

---

## Technical Stack
* Languages and Frameworks: Python, FastAPI, SQLite, Pytest, Docker
...
1. Clone the repository:
   git clone https://github.com/humanity-co/warehouse-object-tracking-api.git
   cd warehouse-object-tracking-api
